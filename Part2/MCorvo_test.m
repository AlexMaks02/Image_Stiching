...
nimg1 = imread("../../Panorama/mcorvo_a.jpg");
nimg2 = imread("../../Panorama/mcorvo_b.jpg");
nimg3 = imread("../../Panorama/mcorvo_c.jpg");

img1 = im2gray(im2double(imread("../../Panorama/mcorvo_a.jpg")));
img2 = im2gray(im2double(imread("../../Panorama/mcorvo_b.jpg")));
img3 = im2gray(im2double(imread("../../Panorama/mcorvo_c.jpg")));

img1RGB = im2double(imread("../../Panorama/mcorvo_a.jpg"));
img2RGB = im2double(imread("../../Panorama/mcorvo_b.jpg"));
img3RGB = im2double(imread("../../Panorama/mcorvo_c.jpg"));
...
saveas(fig1, "../../Results/Panorama_MCorvo/Matched Points img1 and img2.png");
saveas(fig2, "../../Results/Panorama_MCorvo/Matched Points img2 and img3.png");
%% RANSAC
% RANSAC
[H12, nBest12] = RANSAC(matchedPoints1, matchedPoints21, 1000, 0.9);
[H32, nBest32] = RANSAC(matchedPoints3, matchedPoints23, 1000, 0.9);
...
if flag == 1
    ...
    drawnow;
    saveas(figPoints12Calculated, "../../Results/Panorama_MCorvo/points_1_to_2_calculated.png")
    ...
    legend("Calculated points","Matched points")
    drawnow;
    saveas(figPoints32Calculated, "../../Results/Panorama_MCorvo/points_3_to_2_calculated.png");
end
%% Image Stitching
...
if flag == 1
    figComposed1 = figure;
    imshow(imgComposed1);
    saveas(figComposed1,"../../Results/Panorama_MCorvo/ImageComposed1.png");

    figComposed2 = figure;
    imshow(imgComposed2);
    saveas(figComposed2,"../../Results/Panorama_MCorvo/ImageComposed2.png")
end
RemoveWhiteSpace([], 'file', "../../Results/Panorama_MCorvo/ImageComposed1.png");
RemoveWhiteSpace([], 'file', "../../Results/Panorama_MCorvo/ImageComposed2.png");

%% Here we go again
clc; clear; flag = 1;
nimg1 = imread("../../Results/Panorama_MCorvo/ImageComposed1.png");
nimg2 = imread("../../Results/Panorama_MCorvo/ImageComposed2.png");

img1 = im2gray(im2double(imread("../../Results/Panorama_MCorvo/ImageComposed1.png")));
img2 = im2gray(im2double(imread("../../Results/Panorama_MCorvo/ImageComposed2.png")));

img1RGB = im2double(imread("../../Results/Panorama_MCorvo/ImageComposed1.png"));
img2RGB = im2double(imread("../../Results/Panorama_MCorvo/ImageComposed2.png"));
...
if flag == 1
    ...
    legend("Matched Points 1","Matched Points 2");
    drawnow;
    saveas(fig1, "../../Results/Panorama_MCorvo/Matched Points imgComposed1 and imgComposed2.png");
end
[H, nBest] = RANSAC(matchedPoints1, matchedPoints2, 1000, 0.9);
...
if flag == 1
    ...
    legend("Calculated points","Matched points")
    drawnow;
    saveas(figPoints12Calculated, "../../Results/Panorama_MCorvo/points_1Comp_to_2Comp_calculated.png")
end
...
saveas(figComposed,"../../Results/Panorama_MCorvo/FinalImageComposed.png");

RemoveWhiteSpace([], 'file', "../../Results/Panorama_MCorvo/FinalImageComposed.png");
...
saveas(figCroppedImage,"../../Results/Panorama_MCorvo/FinalCroppedImageComposed.png");
